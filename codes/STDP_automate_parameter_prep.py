...
logging.info("MODIFY keithley_interchannelPulseTrain_stdp_automate.py")
    # Read file and modify content
print(f"{'='*5}\keithley_interchannelPulseTrain_stdp_automate.py\n{'='*5}")
...
lines[89]= 'file_path = \"C:/Users/20245580/LabCode/Codes_For_Experiments/exp_data' \
                        + '/' + exp_date + '/pulse_exp.csv\"' \
                        + '\n' 
    # record file exp_avg path
lines[90]= 'file_path_avg = \"C:/Users/20245580/LabCode/Codes_For_Experiments/exp_data' \
