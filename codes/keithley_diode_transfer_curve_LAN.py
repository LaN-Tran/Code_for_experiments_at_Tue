...
file_path = "C:/Users/20245580/LabCode/Codes_For_Experiments/exp_data/20260408/transfer_curve_diode.csv"
...
try:
    ...
    field_names =  ['time', 'i_channel', 'v_drain','i_gate', 'v_gate']
        # in this diode, v_gate is the sweeping voltage between the two terminals.
        # i_gate is the measured current.
        # v_drain, i_channel are dummy.
    ...
    keithley_instrument.write('smub.reset()')
                ...
                # Clear buffer 1.
    keithley_instrument.write(f"smub.nvbuffer1.clear()")
    ...
    keithley_instrument.write('display.smua.measure.func = display.MEASURE_DCAMPS')
                    ...
                    # Select measure I autorange.
    keithley_instrument.write('smua.measure.autozero = smua.AUTOZERO_OFF')
