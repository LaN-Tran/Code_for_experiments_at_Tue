...
# # ======
# # 2 plots, transfer curve vg-id, vg-ig
# # ======
# device = pd.read_csv(r"C:\Users\20244988\Documents\Kiethleys\Keithleys_python\data\transfer_curve.csv")
...
# ======
# 4 plots, transfer curve vg-id, vg-ig
# ======
device = pd.read_csv(r"C:\Users\20176985\Downloads\Keithleys_python\data\ecram.csv")

device_t = device['time']
device_ich = device['i_channel']
device_ig = device['i_gate']
device_vg = device['v_gate']
device_vout = device['v_output']
...
axs[0,0].plot(device_t, device_vg)
axs[1,0].plot(device_t, device_ich)
axs[0,1].plot(device_t, device_vout)
